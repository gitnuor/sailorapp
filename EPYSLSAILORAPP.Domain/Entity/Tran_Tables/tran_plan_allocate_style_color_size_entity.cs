...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("tran_plan_allocate_style_color_size")]
    public class tran_plan_allocate_style_color_size_entity : DapperExt
    {
