...
{ [System.ComponentModel.DataAnnotations.Schema.Table("tran_sub_contract_request")]

		public class tran_sub_contract_request_entity : DapperExt
		{
			...
			public Int64? approved_by  { get; set;}
 			...
 			[Column("tran_sub_contract_request_details")]
