...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("tran_finishing_receive")]

    public class tran_finishing_receive_entity : DapperExt
    {
        ...
        [Column("tran_finish_receive_details")]
