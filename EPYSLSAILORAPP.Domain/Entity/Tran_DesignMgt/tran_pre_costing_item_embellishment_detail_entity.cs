...
namespace EPYSLSAILORAPP.Domain.Entity.Tran_DesignMgt
{
    ...
    [System.ComponentModel.DataAnnotations.Schema.Table("tran_pre_costing_item_embellishment_detail")]

    public class tran_pre_costing_item_embellishment_detail_entity : DapperExt
    {

        [Key]
        public long? tran_pre_costing_item_embellishment_detail_id { get; set; }

        public long? tran_pre_costing_id { get; set; }

        public long? style_embellishment_id { get; set; }
