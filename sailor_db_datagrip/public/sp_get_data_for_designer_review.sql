create function sp_get_data_for_designer_review(tran_va_plan_event_id_filter bigint)
...
alter function sp_get_data_for_designer_review(bigint) owner to postgres;

grant execute on function sp_get_data_for_designer_review(bigint) to anon;

grant execute on function sp_get_data_for_designer_review(bigint) to authenticated;

grant execute on function sp_get_data_for_designer_review(bigint) to service_role;
