...
alter function proc_sp_get_pre_costing_data(bigint, bigint, bigint, bigint) owner to postgres;

grant execute on function proc_sp_get_pre_costing_data(bigint, bigint, bigint, bigint) to anon;

grant execute on function proc_sp_get_pre_costing_data(bigint, bigint, bigint, bigint) to authenticated;

grant execute on function proc_sp_get_pre_costing_data(bigint, bigint, bigint, bigint) to service_role;
