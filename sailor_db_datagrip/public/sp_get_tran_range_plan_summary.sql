...
alter function sp_get_tran_range_plan_summary() owner to postgres;

grant execute on function sp_get_tran_range_plan_summary() to anon;

grant execute on function sp_get_tran_range_plan_summary() to authenticated;

grant execute on function sp_get_tran_range_plan_summary() to service_role;
