...
alter function va_plan_getfor_createupdate(bigint, bigint, bigint) owner to postgres;

grant execute on function va_plan_getfor_createupdate(bigint, bigint, bigint) to anon;

grant execute on function va_plan_getfor_createupdate(bigint, bigint, bigint) to authenticated;

grant execute on function va_plan_getfor_createupdate(bigint, bigint, bigint) to service_role;
