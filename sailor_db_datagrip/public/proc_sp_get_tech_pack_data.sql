...
BEGIN
    ...
    RETURN QUERY
        SELECT tdr.tran_designer_review_id,
...
alter function proc_sp_get_tech_pack_data(bigint, bigint, bigint, bigint, bigint) owner to postgres;

grant execute on function proc_sp_get_tech_pack_data(bigint, bigint, bigint, bigint, bigint) to anon;

grant execute on function proc_sp_get_tech_pack_data(bigint, bigint, bigint, bigint, bigint) to authenticated;

grant execute on function proc_sp_get_tech_pack_data(bigint, bigint, bigint, bigint, bigint) to service_role;
