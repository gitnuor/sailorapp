create function range_plan_getfor_view(year_id_filter bigint, event_id_filter bigint)
...
alter function range_plan_getfor_view(bigint, bigint) owner to postgres;

grant execute on function range_plan_getfor_view(bigint, bigint) to anon;

grant execute on function range_plan_getfor_view(bigint, bigint) to authenticated;

grant execute on function range_plan_getfor_view(bigint, bigint) to service_role;
