create function sp_get_data_for_designer_approval_review(tran_va_plan_event_id_filter bigint)
...
left outer join public.tran_designer_review tdr on tdr.tran_pre_costing_id=tpc.tran_pre_costing_id
 
WHERE tvpd.tran_va_plan_event_id=tran_va_plan_event_id_filter and tdr.is_submitted=true;
...
alter function sp_get_data_for_designer_approval_review(bigint) owner to postgres;

grant execute on function sp_get_data_for_designer_approval_review(bigint) to anon;

grant execute on function sp_get_data_for_designer_approval_review(bigint) to authenticated;

grant execute on function sp_get_data_for_designer_approval_review(bigint) to service_role;
