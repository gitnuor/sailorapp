...
namespace EPYSLSAILORAPP.Infrastructure.Services.Tran_MerchandiserMgt
{
    ...
    public class DraftPRService : IDraftPRService
    {
  ...
  //      }
  //      public async Task<List<rpc_draft_purchase_requisition_DTO>> GetAllJoined_TranPurchaseRequisitionAsync(Int64 currnet_page, Int64 page_size, Int64 fiscal_year_id, Int64 event_id, Int64 supplier_id, long delivery_unit_id)
  //      {
  //          try
  //          {
  //              await _connectionSupabse.InitializeAsync();
  ...
  //              var response = await _connectionSupabse.Rpc("proc_sp_get_data_draft_purchase_requisition", objFilter);

  //              return JsonConvert.DeserializeObject<List<rpc_draft_purchase_requisition_DTO>>(response.Content);
