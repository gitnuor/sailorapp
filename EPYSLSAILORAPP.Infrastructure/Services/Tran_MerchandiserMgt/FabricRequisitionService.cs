...
//namespace EPYSLSAILORAPP.Infrastructure.Services.Tran_MerchandiserMgt
//{

//    public class FabricRequisitionService : IFabricRequisitionService
//    {
...
//        public FabricRequisitionService(IGenItemMasterService GenItemMasterService, IGenMeasurementUnitDetailService GenMeasurementUnitDetailService, IConfiguration configuration, IMapper mapper, IHostingEnvironment hostingEnvironment, ILogger<TranDesignerReviewService> logger)
//        {
...
//        }
        ...
        //        long pr_id = 0;
        //        entity.gen_item_structure_group_id = 1;
    ...
    //            var response = await _connectionSupabse.From<tran_purchase_requisition_entity>().Select("*").Where(x => x.gen_item_structure_group_id == 1).Get();
    ...
    //               .Where(x => x.gen_item_structure_group_id == group_id)
    ...
    //            objFilter.Add("p_delivery_unit_id", delivery_unit_id);
				...
				//var response = await _connectionSupabse.Rpc("proc_sp_get_data_tran_purchase_requisition_merchandise_fabric", objFilter);
