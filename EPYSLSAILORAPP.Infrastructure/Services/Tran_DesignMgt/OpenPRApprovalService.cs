...
namespace EPYSLSAILORAPP.Infrastructure.Services.Tran_DesignMgt
{
    ...
    public class OpenPRApprovalService : IOpenPRApprovalService
    {

        private readonly IConfiguration _configuration;

        private readonly IMapper _mapper;
        private readonly ILogger<OpenPRApprovalService> _logger;
        ...
        public OpenPRApprovalService(IGenItemMasterService GenItemMasterService, IGenMeasurementUnitDetailService GenMeasurementUnitDetailService, IConfiguration configuration, IMapper mapper, IHostingEnvironment hostingEnvironment, ILogger<OpenPRApprovalService> logger)
        {
        ...
        //      }
        //      public async Task<bool> DraftSaveAsync(long pr_id)
        //      {
        //          try
        //          {
        //              await _connectionSupabse.InitializeAsync();
        ...
        //              var response = await _connectionSupabse.Rpc("proc_sp_get_data_tran_purchase_requisition_pending_approvall", objFilter);
        ...
        //      public async Task<List<rpc_tran_purchase_requisition_DTO>> GetAllJoined_TranPurchaseRequisitionApprovedAsync(Int64 currnet_page, Int64 page_size, Int64 fiscal_year_id, Int64 event_id, Int64 supplier_id, long delivery_unit_id)
        //      {
        //          try
        //          {
        //              await _connectionSupabse.InitializeAsync();
        ...
        //              var response = await _connectionSupabse.Rpc("proc_sp_get_data_tran_purchase_requisition_approvall", objFilter);
