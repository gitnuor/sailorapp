...
namespace EPYSLSAILORAPP.Infrastructure.Services.Tran_DesignMgt
{
    ...
    public class FabricBookingRequisitionService : IFabricBookingRequisitionService
    {
        ...
        public FabricBookingRequisitionService(IGenMeasurementUnitDetailService GenMeasurementUnitDetailService, IGenItemMasterService GenItemMasterService, IConfiguration configuration, IMapper mapper, IHostingEnvironment hostingEnvironment, ILogger<TranDesignerReviewService> logger)
        {
  ...
  //              var response = await _connectionSupabse.Rpc("proc_sp_get_data_tran_purchase_requisition", objFilter);
  ...
  //              var response = await _connectionSupabse.Rpc("proc_sp_get_data_tran_purchase_requisition_v2", objFilter);
