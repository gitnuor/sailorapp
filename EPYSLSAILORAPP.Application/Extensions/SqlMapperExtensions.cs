...
namespace Dapper.Contrib.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        public static T GetM<T>(this IDbConnection connection, dynamic id, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            var type = typeof(T);

            if (!GetQueries.TryGetValue(type.TypeHandle, out string sql))
            {
                var key = GetSingleKey<T>(nameof(GetM));
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>Entity of T</returns>
        public static IEnumerable<T> GetMAll<T>(this IDbConnection connection, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            var type = typeof(T);
        ...
        public static long InsertM<T>(this IDbConnection connection, T entityToInsert, IDbTransaction transaction = null, Type tp = null, int? commandTimeout = null) where T : class
        {
            var isList = false;
        ...
        public static bool UpdateM<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, Type tp = null, int? commandTimeout = null) where T : class
        {
        ...
        public static bool DeleteM<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, Type tp = null, int? commandTimeout = null) where T : class
        {
        ...
        public static bool DeleteAllM<T>(this IDbConnection connection, IDbTransaction transaction = null, Type tp = null, int? commandTimeout = null) where T : class
        {
            var type = tp == null ? typeof(T) : tp;
