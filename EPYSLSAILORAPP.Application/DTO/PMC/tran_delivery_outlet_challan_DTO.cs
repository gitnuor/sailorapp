...
namespace EPYSLSAILORAPP.Domain.DTO
{
    ...
    public class tran_delivery_outlet_challan_DTO : BaseEntity
    {
        ...
        public JArray? tran_delivery_outlet_challan_id_detail_json { get; set; }
        ...
        public List<tran_delivery_outlet_challan_details_DTO> details { get; set; }

        public string? tran_delivery_outlet_challan_details_list { get; set; }
