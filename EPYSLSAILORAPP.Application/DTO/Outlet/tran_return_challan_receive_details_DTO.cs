...
namespace EPYSLSAILORAPP.Domain.DTO
{
		...
		public class tran_return_challan_receive_details_DTO : BaseEntity
		{

			[Required]
 			[Column("tran_return_challan_receive_details_id")]
			public Int64 tran_return_challan_receive_details_id  { get; set;}
			...
			//public List<tran_return_challan_received_DTO> TranReturnChallanReceived_List {get; set;}
