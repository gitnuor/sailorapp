...
namespace EPYSLSAILORAPP.Domain.DTO
{
    ...
    public class tran_sub_contract_received_DTO : BaseEntity
    {
        ...
        public string? sub_contract_received_details { get; set; }

        public List<tran_sub_contract_received_details_DTO> details { get; set; }
