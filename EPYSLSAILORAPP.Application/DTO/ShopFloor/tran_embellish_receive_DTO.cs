...
namespace EPYSLSAILORAPP.Domain.DTO
{
		...
		public class tran_embellish_receive_DTO : BaseEntity
		{
        ...
        public JArray? embellish_receive_detail_list { get; set; }
        public string tran_embellish_receive_detail_list { get; set; }
        public List<tran_embellish_receive_detail_DTO> details {get; set;}
