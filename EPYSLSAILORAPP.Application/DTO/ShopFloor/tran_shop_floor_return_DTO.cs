...
namespace EPYSLSAILORAPP.Domain.DTO
{
    ...
    public class tran_shop_floor_return_DTO : BaseEntity
    {
        ...
        public string tran_return_detail_list { get; set; }
        ...
        public JArray? shop_floor_return_details_json { get; set; }
        public List<tran_shop_floor_return_details_DTO> details { get; set; }
