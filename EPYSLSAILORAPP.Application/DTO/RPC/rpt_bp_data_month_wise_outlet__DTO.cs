...
namespace EPYSLSAILORAPP.Domain.RPC
{
    ...
    public class rpc_rpt_bp_data_month_wise_outlet_DTO
    {
        ...
        public List<rpc_rpt_bp_data_month_wise_outlet_det_DTO> OutletList { get; set; }

        public string all_outlets { get; set; }

        public List<rpc_rpt_bp_data_month_wise_outlet_det_DTO> AllOutletList { get; set; }
    }

    public class rpc_rpt_bp_data_month_wise_outlet_det_DTO
    {
