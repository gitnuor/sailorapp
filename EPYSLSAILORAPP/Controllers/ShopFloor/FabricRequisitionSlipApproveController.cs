...
{
    public class FabricRequisitionSlipApproveController : ExtendedBaseController
    {
        private readonly ILogger<FabricRequisitionSlipApproveController> _logger;
        ...
        public FabricRequisitionSlipApproveController(
           ...
           IMapper mapper, ILogger<FabricRequisitionSlipApproveController> logger, IHttpContextAccessor contextAccessor,
        ...
        [HttpGet]
        public async Task<IActionResult> FabricRequisitionSlipApproveLanding()
        {

            return View("~/Views/ShopFloor/FabricRequisitionSlipApprove/FabricRequisitionSlipApproveLanding.cshtml");
        }
        [HttpGet]
        ...
        public async Task<IActionResult> UpdateForApproval([FromBody] tran_mcd_requisition_slip_DTO request)
        {
            ...
            try
            {
                ...
                return Json(new ResultEntity
                {
                    ...
                    Status_Result = (ret == true ? "Data Approved Successfully" : "Data Saving Failed")
                });
            }
            catch (Exception ex)
            {
