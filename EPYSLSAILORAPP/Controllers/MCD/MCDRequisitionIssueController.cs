...
{
    public class MCDRequisitionIssueController : ExtendedBaseController
    {
        private readonly ILogger<MCDRequisitionIssueController> _logger;
        ...
        public MCDRequisitionIssueController(
           IMapper mapper, ILogger<MCDRequisitionIssueController> logger, IHttpContextAccessor contextAccessor,
        ...
        public async Task<IActionResult> MCDRequisitionIssueLanding()
        {
            ...
            return View("~/Views/MCD/MCDRequisitionIssue/MCDRequisitionIssueLanding.cshtml");
        }
        ...
        public async Task<IActionResult> MCDRequisitionIssueLandingApproval()
        {
            ...
            return View("~/Views/MCD/MCDRequisitionIssue/MCDRequisitionIssueLandingApproval.cshtml");
        }
        ...
        public async Task<IActionResult> MCDRequisitionIssueNew(string tran_mcd_requisition_slip_id)
        {
            ...
            return PartialView("~/Views/MCD/MCDRequisitionIssue/_MCDRequisitionIssueNew.cshtml", model);

        }


        [HttpGet]
        public async Task<IActionResult> AddNewFabric(string techPackId, string gen_item_structure_group_sub_id)
        {
            ...
            return PartialView("~/Views/MCD/MCDRequisitionIssue/_FabricDetailsList.cshtml", list);
        ...
        public async Task<IActionResult> GetJoinedMCDRequisitionSlipData(MCD_DtParameters request)
        {
            ...
            var records = await _MCDRequisitionIssueService.GetAllMCDRequisitionSlipAsync(request.Start, request.Length,
        ...
        [HttpPost]
        public async Task<IActionResult> GetDraftRequisitionSlipData(MCD_DtParameters request)
        {
            request.fiscal_year_id = Fiscal_Year_ID;
            request.event_id = Event_ID;

            var records = await _MCDRequisitionIssueService.GetDraftRequisitionSlipData(request.Start, request.Length,
                request.fiscal_year_id, request.event_id,
                                    request.group_id, request.sub_group_id,request.Search.Value);
        ...
        public async Task<IActionResult> GetSubmittedRequisitionSlipData(MCD_DtParameters request)
        {
            ...
            var records = await _MCDRequisitionIssueService.GetSubmittedRequisitionSlipData(request.Start, request.Length,
                request.fiscal_year_id, request.event_id,
                                    request.group_id, request.sub_group_id,request.Search.Value);
        ...
        public async Task<IActionResult> GetAprrovedRequisitionSlipData(MCD_DtParameters request)
        {
            ...
            var records = await _MCDRequisitionIssueService.GetAprrovedRequisitionSlipData(request.Start, request.Length,
                request.fiscal_year_id, request.event_id,
                                    request.group_id, request.sub_group_id,request.Search.Value);
        ...
        public async Task<IActionResult> MCDRequisitionIssueEdit(string tran_mcd_requisition_issue_id)
        {
          ...
          .Select(a =>
            ...
            return PartialView("~/Views/MCD/MCDRequisitionIssue/_MCDRequisitionIssueEdit.cshtml", data);
        ...
        public async Task<IActionResult> MCDRequisitionIssueView(string tran_mcd_requisition_issue_id)
        {
          ...
          .Select(a =>
            ...
            return PartialView("~/Views/MCD/MCDRequisitionIssue/_MCDRequisitionIssueView.cshtml", data);
        ...
        public async Task<IActionResult> MCDRequisitionIssueViewforApproval(string tran_mcd_requisition_issue_id)
        {
          ...
          .Select(a =>
            ...
            return PartialView("~/Views/MCD/MCDRequisitionIssue/_MCDRequisitionIssueApprovalView.cshtml", data);
        ...
        [HttpPost]
        public async Task<IActionResult> ApproveFabricReq([FromBody] long tran_mcd_requisition_issue_id)
        {
            var ret = true;
            ...
            try
            {
                ...
                ret = await _MCDRequisitionIssueService.ApproveFabricReq(tran_mcd_requisition_issue_id, sec_object.userid.Value);
