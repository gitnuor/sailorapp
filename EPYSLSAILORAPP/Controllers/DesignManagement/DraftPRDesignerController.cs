...
{
	public class DraftPRDesignerController : BaseController
    {
        ...
        public DraftPRDesignerController(ApplicationUserManager<owin_user_DTO> userManager,
            ...
            IGenItemMasterService GenItemMasterService, IGenSupplierInformationService GenSupplierInformationService, ITrantechpackService trantechpackService,
           IMapper mapper, ILogger<DraftPRController> logger, IHttpContextAccessor contextAccessor, IConfiguration configuration, IGenunitService genunitService,
            ITranDraftPurchaseRequisitionService TranDraftPurchaseRequisitionService, IGenSeasonEventConfigurationService genseasoneventconfigurationservice,
            IRPCDbService rpc_db_service)
        {
            ...
            _DraftPRService = TranDraftPurchaseRequisitionService;
        ...
        public async Task<IActionResult> DraftPRLanding()
        {
            ...
            return View("~/Views/DesignMgt/DraftPRDesigner/DraftPRLanding.cshtml");
        }
        ...
        public async Task<IActionResult> DraftAccesoriesPRNew()
        {
		   ...
		   .Select(a =>
			...
			return PartialView("~/Views/DesignMgt/DraftPRDesigner/_DraftAccessoriesRequisitionNew.cshtml", model);
        ...
        public async Task<IActionResult> DraftFabricPRNew()
        {
           ...
           .Select(a =>
            ...
            return PartialView("~/Views/DesignMgt/DraftPRDesigner/_DraftFabricRequisitionNew.cshtml", model);
        ...
        public async Task<IActionResult> DraftPREdit(string pr_id)
        {
            ...
            return PartialView("~/Views/DesignMgt/DraftPRDesigner/_DraftPREdit.cshtml", model);
        ...
        public async Task<IActionResult> DraftPRView(string pr_id)
        {
			...
			return PartialView("~/Views/DesignMgt/DraftPRDesigner/_DraftPRView.cshtml", model);
        ...
        public async Task<IActionResult> GetDraftPRData(DtParameters request)
        {
            ...
            var records = await _DraftPRService.GetAllPagedDataAsync(request);
         ...
         public async Task<IActionResult> DeleteDraftPR([FromBody] tran_draft_purchase_requisition_DTO request)
  {
      ...
      catch (Exception ex)
      {
		...
		public async Task<IActionResult> AddNewAccessories(string item_structure_group_id, string gen_item_structure_group_sub_id, string measurement_unit_id)
		{
            ...
            return PartialView("~/Views/DesignMgt/DraftPRDesigner/_AddAccessoriesDetails.cshtml", model);
