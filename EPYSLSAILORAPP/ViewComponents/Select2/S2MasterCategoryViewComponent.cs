...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    /// SideBarMenu
    /// </summary>
    public class S2MasterCategoryViewComponent : ViewComponent
    {
        ...
        /// </summary>
        public S2MasterCategoryViewComponent(IHttpContextAccessor contextAccessor, 
            ...
            bool isRequired= false, bool isReadOnly = false, string placeholder="",string preloaded="",string model_parentid="")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2MasterCategory.cshtml");
        }
