...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    /// SideBarMenu
    /// </summary>
    public class S2GenGarmentPartViewComponent : ViewComponent
    {
        ...
        /// </summary>
        public S2GenGarmentPartViewComponent(IHttpContextAccessor contextAccessor, 
            ...
            bool isRequired= false, bool isReadOnly = false, string placeholder="",string preloaded="",string model_parentid="")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2GenGarmentPart.cshtml");
        }
