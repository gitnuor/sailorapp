...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    public class S2RequisitionIssueViewComponent : ViewComponent
    {
        ...
        public S2RequisitionIssueViewComponent(IHttpContextAccessor contextAccessor, 
            ...
            bool isRequired= false, bool isReadOnly = false, string placeholder="",string preloaded="",string model_parentid="")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2RequisitionIssue.cshtml");
        }
