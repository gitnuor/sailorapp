...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    public class S2GenTeamGroupViewComponent : ViewComponent
    {
        ...
        public S2GenTeamGroupViewComponent(IHttpContextAccessor contextAccessor, 
            ...
            bool isRequired= false, bool isReadOnly = false, string placeholder="",string preloaded="",string model_parentid="")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2GenTeamGroup.cshtml");
        }
