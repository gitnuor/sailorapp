...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    public class S2TranScmPoViewComponent : ViewComponent
    {
        ...
        public S2TranScmPoViewComponent(IHttpContextAccessor contextAccessor, 
            ...
            bool isRequired= false, bool isReadOnly = false, string placeholder="",string preloaded="",string model_parentid="")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2TranScmPo.cshtml");
        }
