...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    public class S2TechPackViewComponent : ViewComponent
    {
        ...
        public S2TechPackViewComponent(IHttpContextAccessor contextAccessor)
        {
            //_config = config;
            ...
            bool isRequired = false, bool isReadOnly = false, string placeholder = "", string preloaded = "", string model_parentid = "")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2TechPack.cshtml");
        }

    }

   
    public class S2TechPackforPPViewComponent : ViewComponent
    {
        ...
        public S2TechPackforPPViewComponent(IHttpContextAccessor contextAccessor)
        {
            //_config = config;
            _contextAccessor = contextAccessor;
            ...
            bool isRequired = false, bool isReadOnly = false, string placeholder = "", string preloaded = "", string model_parentid = "")
        {
            ...
            return View("~/Views/Shared/Components/Select2/S2TechPackPPMeeting.cshtml");
        }
