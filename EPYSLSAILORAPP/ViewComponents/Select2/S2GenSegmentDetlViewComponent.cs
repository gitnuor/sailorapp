...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    /// SideBarMenu
    /// </summary>
    public class S2GenSegmentDetlViewComponent : ViewComponent
    {
        ...
        /// </summary>
        public S2GenSegmentDetlViewComponent(IHttpContextAccessor contextAccessor, 
        ...
        public IViewComponentResult Invoke(string ddlId,string SegmentGroupID="", string selectedvalue="", string cssclass = "",
            bool isRequired= false, bool isReadOnly = false, string placeholder="",string preloaded="",string model_parentid="")
        {
            ...
            ViewBag.SegmentGroupID= Convert.ToInt32(SegmentGroupID);

            return View("~/Views/Shared/Components/Select2/S2GenSegmentDetl.cshtml");
        }
