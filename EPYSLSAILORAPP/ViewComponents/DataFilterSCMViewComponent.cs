...
namespace EPYSLSAILORAPP.ViewComponents
{
    ...
    /// SideBarMenu
    /// </summary>
    public class DataFilterSCMViewComponent : ViewComponent
    {
        ...
        /// </summary>
        public DataFilterSCMViewComponent(IHttpContextAccessor contextAccessor, IGenUnitService genunitService,
            IRPCDbService rpc_db_service, IGenFiscalYearService GenFiscalYearService,
        ...
        public  IViewComponentResult Invoke()
        {
            ...
            {
                var objfiscal_year=   _GenFiscalYearService.get_fiscal_year_GetAll().Result;
            ...
            var unit_list =  _GenUnitService.GetAllAsync().Result;
            ViewBag.DeliveryUnits = unit_list
           .Select(a =>
                    new SelectListItem
                    {
            ...
            return View("~/Views/Shared/Components/DataFilterSCM.cshtml");
        }
